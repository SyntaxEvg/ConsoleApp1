...
namespace AspNetCoreGeneratedDocument
{
	...
	internal sealed class Areas_Admin_Views__ViewImports : BaseRazorPage<object>
	{
		...
		{
			Areas_Admin_Views__ViewImports.<ExecuteAsync>d__0 <ExecuteAsync>d__;
			<ExecuteAsync>d__.<>t__builder = AsyncTaskMethodBuilder.Create();
			<ExecuteAsync>d__.<>1__state = -1;
			<ExecuteAsync>d__.<>t__builder.Start<Areas_Admin_Views__ViewImports.<ExecuteAsync>d__0>(ref <ExecuteAsync>d__);
